...
- Keep every existing constraint: ALL body content inside <div class="velpi-page">, every CSS selector prefixed .velpi-page, ALL CSS in ONE <style> tag with Google Fonts via @import at its top, NO JavaScript, no position:fixed (sticky is fine).
