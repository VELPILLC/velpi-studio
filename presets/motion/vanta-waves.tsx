/**
 * SOURCE: https://github.com/tengbao/vanta/blob/master/src/vanta.waves.js
 * REPO: https://github.com/tengbao/vanta
 * LICENSE: MIT
 * AUTHOR: Vanta.js (Teng Bao)
 * EFFECT: background
 * INTENSITY: bold
 * DEPENDENCY: webgl
 * CSS-PORT: approximate: layered dark wavy radial/linear gradients slowly undulating via transform/background-position keyframes cannot equal 3D water; the port uses two blurred gradient "swells" drifting in counter-phase over a deep base color.
 *
 * Usage (three.js required):
 *   VANTA.WAVES({ el: "#hero", color: 0x005588, shininess: 30, waveHeight: 15, waveSpeed: 1, zoom: 1 })
 * Full effect source below (unmodified).
 */
