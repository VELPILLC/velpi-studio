/**
 * SOURCE: https://github.com/magicuidesign/magicui/blob/main/apps/www/registry/magicui/warp-background.tsx
 ...
 * CSS-PORT: approximate: a perspective container with four gridded gradient planes (top/bottom/left/right walls); light beams are gradient stripes translated along each wall on infinite linear keyframes to sell the warp-speed tunnel.
 */
"use client"
