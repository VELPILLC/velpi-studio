/**
 * SOURCE: https://github.com/kokonut-labs/kokonutui/blob/main/components/kokonutui/beams-background.tsx
 * REPO: https://github.com/kokonut-labs/kokonutui
 * LICENSE: MIT
 * AUTHOR: KokonutUI (kokonut-labs)
 * EFFECT: background
 * INTENSITY: medium
 * DEPENDENCY: js-library
 * CSS-PORT: approximate: (canvas-based drifting light beams) several blurred, rotated gradient bars rising slowly on staggered infinite keyframes while pulsing opacity, over a heavy backdrop blur feel.
 */
"use client";
