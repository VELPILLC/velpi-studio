/**
 * SOURCE: https://github.com/tengbao/vanta/blob/master/src/vanta.net.js
 ...
 * INTENSITY: medium
 * DEPENDENCY: webgl
 * CSS-PORT: approximate: a 3D point-and-line network can't be done in pure CSS; the port scatters glowing dots connected by faint gradient lines (fixed layout) that drift and pulse softly.
 *
 * Usage (three.js required):
 *   VANTA.NET({ el: "#hero", color: 0xff3f81, backgroundColor: 0x23153c, points: 10, maxDistance: 20, spacing: 15 })
