/**
 * SOURCE: https://github.com/magicuidesign/magicui/blob/main/apps/www/registry/magicui/animated-shiny-text.tsx
 ...
 * INTENSITY: subtle
 * DEPENDENCY: css-only
 * CSS-PORT: direct: a narrow light gradient layered over the text with background-clip:text and an animated background-position sweep, exactly as the Tailwind utilities compile.
 */
import {
