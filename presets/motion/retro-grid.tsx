/**
 * SOURCE: https://github.com/magicuidesign/magicui/blob/main/apps/www/registry/magicui/retro-grid.tsx
 ...
 * INTENSITY: medium
 * DEPENDENCY: webgl
 * CSS-PORT: approximate: classic CSS retro grid - a perspective-rotated plane (rotateX) covered with repeating grid lines, scrolled toward the viewer with a translateY keyframe loop and a horizon fade. (The component itself renders via WebGL shader with a CSS fallback.)
 */
"use client"
