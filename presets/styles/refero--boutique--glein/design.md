...
|------|-------|------|-------|
| Midnight Ink | `#000000` | Primary text, nav hairline borders, footer dividers, section rules, button text. Dominant structural color — defines the graphic skeleton against the warm canvas | neutral |
| Bone White | `#ffffff` | Page canvas, card surfaces, overlay text on dark imagery, cookie dialog background. The breathing space | neutral |
| Warm Sand | `#ebe6dc` | Secondary surface and section bands — the warm beige that gives the atelier its linen-like tactility. Section dividers, footer wash, category card backgrounds | neutral |
| Concrete Gray | `#8c8c8c` | Muted secondary text, tertiary borders, subdued image overlays. The recede color — present but never competing | neutral |
| Ash Gray | `#b3b3b3` | Subtle dividers, inactive nav borders, low-emphasis rules. The quietest member of the scale | neutral |

## Tokens — Typography

- **F-Grotesk** — sizes: 13px, 15px, 20px, 30px, 111px; weight: 400; line-height: 1.00, 1.19, 1.20, 1.30; letter-spacing: . Role: Primary grotesque — used for everything from body to display. The entire type system runs at weight 400 only; hierarchy is pure scale.
- **Maison-Neue-Mono** — sizes: 13px, 15px, 20px; weight: 400; line-height: 1.00, 1.19, 1.20, 1.30; letter-spacing: . Role: Monospace companion — navigation, category labels, button text, footer meta, promotional strip. The 'labelling' voice that contrasts the editorial grotesque.

## Type Scale

- caption: 13px / lh 1.2 / ls undefined
- body-sm: 15px / lh 1.19 / ls undefined
- subheading: 20px / lh 1.3 / ls undefined
- heading: 30px / lh 1 / ls undefined
- display: 111px / lh 1 / ls undefined

## Spacing & Shape

- Radius — buttons: 0px, cards: 0px, inputs: 0px, tags: 0px
- Element gap: 13px; Section gap: 42px; Card padding: 13px; Page max-width: fluid
