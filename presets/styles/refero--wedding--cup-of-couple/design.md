...
|------|-------|------|-------|
| Ink Charcoal | `#303030` | Primary text, all UI borders, nav rules, image borders — the only non-white structural color in the system. The brand's deliberate refusal to go pure black gives headlines a softer, printed feel | neutral |
| Dust Gray | `#808080` | Secondary borders, card dividers, footer rules, tertiary UI separators — a mid-gray that recedes behind content and never competes with photography | neutral |
| Bone | `#f0f0f0` | Card surfaces, subtle elevation against the white page, light shadow tints — warms the page away from clinical white and echoes paper stock | neutral |
| Faded Pencil | `#767676` | Rare nav underline / accent rule — used sparingly where a separator needs slightly more presence than Dust Gray | neutral |

## Tokens — Typography

- **ITCFranklinGothicStdBook** — sizes: 10px, 16px; weight: 400; line-height: 1.05 / 1.20; letter-spacing: . Role: UI sans — nav items, category labels (CAFÉS | MADRID), dates, footer micro-copy, tag metadata. The single weight 400 acts as a quiet utilitarian voice that stays out of the way of imagery and serif titles.
- **Garamond** — sizes: 17px, 28px; weight: 400; line-height: 1.00 / 1.20; letter-spacing: . Role: Project card titles, section labels, and secondary prose. The 28px Garamond with line-height 1.00 sits tight and dense like editorial captions, while 17px handles body-level text in lists and inputs. Its classical proportions give the grid a literary tone.
- **PerpetuaTitlingMT** — sizes: 25px, 32px, 40px, 48px; weight: 400; line-height: 1.20; letter-spacing: . Role: Major section and page titles — the 48px tier anchors featured-project headers while 25–40px handles sub-section and card-stack headlines. Perpetua's titling proportions (narrow caps, tall x-height) give the layout a stately, museum-label quality.
- **DisplaceKC** — sizes: 72px; weight: 400; line-height: 1.20; letter-spacing: . Role: The wordmark only — the 'CUP OF COUPLE' logo at 72px. This is the system's single moment of typographic spectacle: the custom face's distorted, slightly retro character sets the entire editorial mood and is never reused elsewhere.

## Type Scale

- caption: 10px / lh 1.05 / ls undefined
- body-sm: 16px / lh 1.2 / ls undefined
- subheading: 25px / lh 1.2 / ls undefined
- heading-sm: 28px / lh 1 / ls undefined
- heading: 32px / lh 1.2 / ls undefined
- heading-lg: 40px / lh 1.2 / ls undefined
- display: 48px / lh 1.2 / ls undefined

## Spacing & Shape

- Radius — buttons: 0px, cards: 0px, inputs: , tags: 0px
- Element gap: 12-18px; Section gap: 36px; Card padding: 12px; Page max-width: 1200px
