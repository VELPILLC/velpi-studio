...
- **ABCMonumentGrotesk** — sizes: 12px, 14px, 16px, 18px, 20px, 22px; weight: 500; line-height: 0.90, 1.00, 1.05, 1.33, 1.43; letter-spacing: -0.04em at 12px, -0.034em at 14px, -0.03em at 16px, -0.027em at 18px, -0.024em at 20–22px (hovering near -0.48px at every step). Role: Sole typeface across all UI — body, labels, nav, headings, buttons, icons, links. The single medium weight with uniformly negative tracking (~-0.48px) gives every label a compressed, display-poster feel regardless of size. Avoid pairing with a secondary face; the constraint IS the identity.

## Type Scale

- caption: 12px / lh 0.9 / ls -0.48
- body-sm: 14px / lh 1 / ls -0.476
- body: 16px / lh 1.05 / ls -0.48
- subheading: 18px / lh 1.33 / ls -0.486
- heading-sm: 20px / lh 1.33 / ls -0.48
- heading: 22px / lh 1.43 / ls -0.528

## Spacing & Shape

- Radius — buttons: 9999px, cards: , inputs: , tags: 9999px
- Element gap: 8px; Section gap: 48-64px; Card padding: 16-24px; Page max-width: fluid
