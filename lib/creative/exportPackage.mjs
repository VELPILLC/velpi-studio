...
const FIELD_MAP = {
  ...
  developer_review: 'the human developer rating (love/okay/needs_work), flags, and note',
...
export function buildSingleArtifact({ cdo, review, project, fleetContext, generatedAt } = {}) {
  ...
  return {
    ...
    developer_review: review ? { rating: review.rating ?? null, flags: review.flags || [], note: review.note || '' } : null,
    html,
    screenshots,
