...
const FIELD_MAP = {
  ...
  developer_review: 'the human developer rating(s) — { mobile, desktop }, each love/okay/needs_work + flags + note, or null if that device view was never rated',
...
function reviewSummary(r) {
  return r ? { rating: r.rating ?? null, flags: r.flags || [], note: r.note || '' } : null
}
