  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <section>
          ...
          {CONTENT_TYPES.map(t => (
            <button
              ...
              style={{
                ...
                border: '1px solid ' + (contentType === t ? '#0d7030' : 'rgba(41,144,250,0.3)'),
                color: contentType === t ? 'white' : 'rgba(255,255,255,0.4)',
                borderRadius: 6,
        ...
        <ChatBox messages={messages} onSend={sendChat} loading={chatLoading} />
      </section>
          ...
          <div style={{ display: 'flex', gap: 8, marginBottom: '1rem' }}>
            {FORMATS.map(f => (
              <button
                ...
                onClick={() => setFormat(f)}
                style={{
                  background: format.label === f.label ? '#2990fa' : '#060d1f',
                  border: '1px solid ' + (format.label === f.label ? '#2990fa' : 'rgba(41,144,250,0.3)'),
                  color: format.label === f.label ? 'white' : 'rgba(255,255,255,0.4)',
                  borderRadius: 6,
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <div
                ...
                style={{
                  ...
                  overflow: 'hidden',
                  borderRadius: 10,
                  boxShadow: '0 0 0 1px rgba(41,144,250,0.3)',
                  background: '#000',
                  flexShrink: 0,
                }}
              >
