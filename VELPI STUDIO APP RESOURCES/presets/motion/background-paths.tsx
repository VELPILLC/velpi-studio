/**
 * SOURCE: https://github.com/kokonut-labs/kokonutui/blob/main/components/kokonutui/background-paths.tsx
 ...
 * CSS-PORT: approximate: inline SVG with a handful of flowing curved strokes; stroke-dashoffset keyframes make the lines draw and fade in sequence, mimicking the motion pathLength animation.
 */
"use client";
