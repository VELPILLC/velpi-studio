/**
 * SOURCE: https://github.com/educlopez/smoothui/blob/main/packages/smoothui/components/scroll-reveal-paragraph/index.tsx
 * REPO: https://github.com/educlopez/smoothui
 * LICENSE: MIT
 * AUTHOR: SmoothUI (Eduardo Calvo)
 * EFFECT: scroll-trigger
 * INTENSITY: subtle
 * DEPENDENCY: framer-motion
 * CSS-PORT: approximate: CSS scroll-driven animation (animation-timeline: view()) fades/lifts the paragraph as it enters the viewport, wrapped in @supports so browsers without scroll timelines simply show the text.
 */
"use client";
